...
class conexion_server{
  ...
  public:
     ...
     void Recibir_Mapa(char m[100][100]);
...
class conexion_client{
  ...
  public:
     ...
     void Recibir_Msg_NoBlocking(char *vision, char *objetos, string &mensaje, bool &reiniciar, char &en_uso,
                                 char *mochila, char *puntuacion, bool &finjuego, char &vida,	bool &recibido);
     void Enviar_Mapa(char m[100][100]);
